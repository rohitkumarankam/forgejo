...
func TestAccessTokenWithPKCE(t *testing.T) {
	...
	t.Run("S256 method", func(t *testing.T) {
		...
		t.Run("Grant", func(t *testing.T) {
			...
			req := NewRequestWithValues(t, "POST", "/login/oauth/grant", map[string]string{
				"_csrf":        GetCSRF(t, session, "/login/oauth/authorize?client_id=ce5a1322-42a7-11ed-b878-0242ac120002&redirect_uri=b&response_type=code&code_challenge_method=S256&code_challenge="+hashedVerifier+"&state=thestate"),
				"client_id":    "ce5a1322-42a7-11ed-b878-0242ac120002",
				"redirect_uri": "b",
				"state":        "thestate",
				"granted":      "true",
